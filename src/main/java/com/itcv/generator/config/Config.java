...
public class  Config {
   ...
   /* *//** 作者 *//*
    public static final String AUTHOR = "zf";

    *//** 基础包名 *//*
    public static final String PACKAGE_NAME = "com.linkmed.storage";
    ...
    *//** xml输出目录 *//*
    ...
    /** 数据库链接 *//*
    public static final String DB_URL = "jdbc:mysql://192.168.0.125:3306/empi?useOldAliasMetadataBehavior=true&serverTimezone=Asia/Shanghai&zeroDateTimeBehavior=convertToNull&useSSL=false&characterEncoding=gbk&allowPublicKeyRetrieval=true";
    ...
    *//** 表名，为空，生成所有的表 *//*
    public static final String[] TABLE_NAMES = {"storage_bucket_records"};
