...
public class CommonUtils {
    ...
    private static GlobalConfig globalConfig() {
        return new GlobalConfig()
                .setAuthor(CommonConfig.author)
                .setOutputDir(CommonConfig.outputDir)
...
//                    config.setServiceName("%sService");
     ...
     * @return
     */
    private static InjectionConfig injectionConfig(final PackageConfig packageConfig, String[] commonField, String packageName) {
        ...
        fileOutConfigList.add(new FileOutConfig("/templates/dto.java.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return CommonConfig.outputDir + "/" + pathAll + "dto/" + tableInfo.getEntityName() + "DTO" + StringPool.DOT_JAVA;
            }
        });
        fileOutConfigList.add(new FileOutConfig("/templates/mapper.xml.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return CommonConfig.outputXml + "/" + tableInfo.getXmlName() + StringPool.DOT_XML;
    ...
    public static void execute(DbType dbType, String dbUrl, String username, String password, String driver,
                               String [] tablePrefixes, String [] tableNames, String packageName, String [] fieldPrefixes, String[] commonField) {
        ...
        InjectionConfig injectionConfig = injectionConfig(packageConfig, commonField, packageName);
